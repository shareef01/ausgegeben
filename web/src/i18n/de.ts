...
export const de: Record<TranslationKey, string> = {
  ...
  authCloudHint: 'Verwende dieselbe E-Mail oder dasselbe Google-Konto wie auf dem Handy.',
  authOr: 'oder',
  ...
  authErrorPopupClosed: 'Anmelde-Popup wurde geschlossen. Bitte erneut versuchen.',
  authSignIn: 'Anmelden',
