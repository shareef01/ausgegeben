export const en = {
  ...
  authRememberMeSub: 'leave unchecked on shared or public devices',
  ...
  settingsLocalCleanupFailed: 'signed out, but local financial data could not be cleared. close other app tabs and clear this site’s data.',
  ...
  settingsTrustedDevice: 'trusted device offline storage',
  settingsTrustedDeviceSub: 'keep financial data across browser restarts; leave off on shared devices',
  settingsPersistentAuth: 'keep me signed in',
  settingsPersistentAuthSub: 'stay signed in across browser restarts; leave off on shared devices',
