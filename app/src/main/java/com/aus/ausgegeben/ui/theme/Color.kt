...
val SurfaceElevatedDark = Color(0xFF222228)
val SurfaceVariantDark = Color(0xFF2A2A30)
val TertiarySurfaceDark = Color(0xFF323238)
val OutlineDark = Color(0xFF3A3A42)
val OutlineVariantDark = Color(0xFF48484F)
val SeparatorDark = Color(0xFF52525A)
val GlassOverlayDark = Color(0xE61A1A1E)

// ── Brand & semantic accents (restrained, cohesive) ────────────────────────
val AccentCoral = Color(0xFFFF6B57)
...
val OnSurfaceVariantDark = Color(0xFFA8A8B0)
